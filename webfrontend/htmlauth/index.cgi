...
# ---------------------------------------
if (param('savedata')) {
	$conf = new Config::Simple("$home/config/plugins/$psubfolder/gardena.cfg");
	...
	$conf->param('GARDENA.USERNAME', unquotemeta($username));
	$conf->param('GARDENA.PASSWORD', unquotemeta($password));
	$conf->param('GARDENA.MINISERVER', unquotemeta($miniserver));
	$conf->param('GARDENA.UDPPORT', unquotemeta($msudpport));
	$conf->param('GARDENA.ENABLED', unquotemeta($enabled));
	$conf->param('GARDENA.LOCALTIME', unquotemeta($localtime));
...
# ---------------------------------------
$conf = new Config::Simple("$home/config/plugins/$psubfolder/gardena.cfg");
$username = encode_entities($conf->param('GARDENA.USERNAME'));
$password = encode_entities($conf->param('GARDENA.PASSWORD'));
$miniserver = encode_entities($conf->param('GARDENA.MINISERVER'));
$msudpport = encode_entities($conf->param('GARDENA.UDPPORT'));
$enabled = encode_entities($conf->param('GARDENA.ENABLED'));
$localtime = encode_entities($conf->param('GARDENA.LOCALTIME'));
